          ...
          <li>
            {user?.uid ? (
              <button
                ...
                className="btn px-2 py-3 font-medium bg-yellow-400 hover:bg-yellow-500 border-none text-black rounded-xl"
              >
                Log out
              </button>
            ) : (
              <Link to="/login">
                <button className="btn px-2 py-3 font-medium bg-yellow-400 hover:bg-yellow-500 border-none text-black rounded-xl">
                  Login
                </button>
              </Link>
            )}
