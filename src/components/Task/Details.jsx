        ...
        >
          <PhotoView src={image}>
            <img
              ...
              className="rounded-lg w-full h-64 cursor-pointer"
              src={image}
              alt="phone"
            />
          </PhotoView>
          ...
          <div>
            <span className="text-xs font-medium text-blue-600 uppercase dark:text-blue-400">
              {completed === "true" ? (
                ...
                <button className="px-2 py-3 rounded bg-red-500 text-white">
                  Not Completed
                </button>
              )}
            </span>
            <h1
              className="block mt-2 text-2xl font-semibold transition-colors duration-300 transform text-white"
              tabIndex="0"
              role="link"
            >
              {title}
